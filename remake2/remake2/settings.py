"""
Django settings for remake2 project.
...
SECRET_KEY = "django-insecure-mx2%r25bo)cffil2lghts3*zqon+3wsbz2@sxx^3zo1(xz@qy3"
...
WSGI_APPLICATION = "remake2.wsgi.application"
